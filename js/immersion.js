...
const IMMERSION_STRINGS = {
  ...
  aiDetectButton: { es: "Detección por IA", ja: "AI検出", fr: "Détection IA" },
  nameGrammarPointLabel: { es: "Nombre del punto gramatical, en tus propias palabras", ja: "文法ポイントの名前（自分の言葉で）", fr: "Nom du point de grammaire, dans vos propres mots" },
  exampleSentenceTargetLabel: { es: "Frase de ejemplo en japonés", ja: "日本語の例文", fr: "Phrase d'exemple en japonais" },
  exampleSentenceEnglishLabel: { es: "Frase de ejemplo en inglés", ja: "英語の例文", fr: "Phrase d'exemple en anglais" },
  nuanceNoteLabel: { es: "Matiz y nota personal", ja: "ニュアンスと個人メモ", fr: "Nuance et note personnelle" },
  formationRuleLabel: { es: "Regla de formación", ja: "活用ルール", fr: "Règle de formation" },
  confirmStructureLabel: { es: "Aceptar la detección por IA para esta plantilla de estructura", ja: "この構造テンプレートのAI検出を承認する", fr: "Accepter la détection IA pour ce modèle de structure" },
  confirmStructureHint: { es: "Ejecuta la detección por IA arriba al menos una vez para activar esto.", ja: "これを有効にするには、上のAI検出を少なくとも1回実行してください。", fr: "Exécutez la détection IA ci-dessus au moins une fois pour activer ceci." },
  generateMoreExamplesButton: { es: "Generar 3 ejemplos más", ja: "例文をあと3つ生成", fr: "Générer 3 exemples de plus" },
  quickConjugationTestHeading: { es: "Prueba rápida de conjugación", ja: "クイック活用テスト", fr: "Test de conjugaison rapide" },
  sentenceTestHeading: { es: "Prueba de oraciones", ja: "文章テスト", fr: "Test de phrases" },
  unlockAfterConfirmHint: { es: "Confirma la detección por IA de la plantilla de estructura arriba para desbloquear esto.", ja: "これを解除するには、上の構造テンプレートのAI検出を確定してください。", fr: "Confirmez la détection IA du modèle de structure ci-dessus pour débloquer ceci." },
  showExampleButton: { es: "Ver ejemplo", ja: "例を見る", fr: "Voir un exemple" },
  exampleOverlayTitle: { es: "Ejemplo: nota completa", ja: "例：記入済みのノート", fr: "Exemple : note remplie" },
  generateButton: { es: "Generar", ja: "生成", fr: "Générer" },
