...
(function (root) {
  ...
  // `transitive` is hand-checked per entry, purely to decide whether
  // this verb's PASSIVE form gets a natural-reading English cue
  // sentence out of the fixed "It was {past participle}." template
  // (see japanese-conjugation-test-app.js) — intransitive verbs like
  // "die" or "live" don't passivize in English the way "write" or
  // "lend" do, so "It was died"/"It was lived" reads as broken English
  // even though the Japanese form itself (死なれる, etc.) is real
  // grammar. Deliberately a fixed, manually-verified flag rather than
  // an AI judgment call at question-generation time, per the same
  // "small closed set, verify once" philosophy as the class field
  // above — no per-question uncertainty about whether a given cue
  // sentence will make sense. Potential/causative/causative-passive
  // are unaffected either way (their templates read fine for any verb,
  // transitive or not), so this flag only ever gates the passive form.
  const COMMON_VERBS = [
    { kanji: "飲む", reading: "のむ", meaning: "to drink", class: "godan", transitive: true },
    { kanji: "話す", reading: "はなす", meaning: "to speak, to talk", class: "godan", transitive: true },
    { kanji: "書く", reading: "かく", meaning: "to write", class: "godan", transitive: true },
    { kanji: "聞く", reading: "きく", meaning: "to listen, to hear, to ask", class: "godan", transitive: true },
    { kanji: "読む", reading: "よむ", meaning: "to read", class: "godan", transitive: true },
    { kanji: "泳ぐ", reading: "およぐ", meaning: "to swim", class: "godan", transitive: false },
    { kanji: "脱ぐ", reading: "ぬぐ", meaning: "to take off (clothes)", class: "godan", transitive: true },
    { kanji: "待つ", reading: "まつ", meaning: "to wait", class: "godan", transitive: false },
    { kanji: "死ぬ", reading: "しぬ", meaning: "to die", class: "godan", transitive: false },
    { kanji: "遊ぶ", reading: "あそぶ", meaning: "to play", class: "godan", transitive: true },
    { kanji: "呼ぶ", reading: "よぶ", meaning: "to call", class: "godan", transitive: true },
    { kanji: "飛ぶ", reading: "とぶ", meaning: "to fly", class: "godan", transitive: false },
    { kanji: "立つ", reading: "たつ", meaning: "to stand", class: "godan", transitive: false },
    { kanji: "買う", reading: "かう", meaning: "to buy", class: "godan", transitive: true },
    { kanji: "言う", reading: "いう", meaning: "to say", class: "godan", transitive: true },
    { kanji: "会う", reading: "あう", meaning: "to meet", class: "godan", transitive: true },
    { kanji: "使う", reading: "つかう", meaning: "to use", class: "godan", transitive: true },
    { kanji: "歌う", reading: "うたう", meaning: "to sing", class: "godan", transitive: true },
    { kanji: "思う", reading: "おもう", meaning: "to think", class: "godan", transitive: true },
    { kanji: "洗う", reading: "あらう", meaning: "to wash", class: "godan", transitive: true },
    { kanji: "笑う", reading: "わらう", meaning: "to laugh", class: "godan", transitive: false },
    // godan verbs ending in る that look like ichidan (the classic trap).
    { kanji: "座る", reading: "すわる", meaning: "to sit", class: "godan", transitive: false },
    { kanji: "走る", reading: "はしる", meaning: "to run", class: "godan", transitive: false },
    { kanji: "帰る", reading: "かえる", meaning: "to go home, to return", class: "godan", transitive: false },
    { kanji: "入る", reading: "はいる", meaning: "to enter", class: "godan", transitive: true },
    { kanji: "知る", reading: "しる", meaning: "to know", class: "godan", transitive: true },
    { kanji: "要る", reading: "いる", meaning: "to need", class: "godan", transitive: true },
    { kanji: "切る", reading: "きる", meaning: "to cut", class: "godan", transitive: true },
    { kanji: "作る", reading: "つくる", meaning: "to make", class: "godan", transitive: true },
    { kanji: "分かる", reading: "わかる", meaning: "to understand", class: "godan", transitive: true },
    { kanji: "持つ", reading: "もつ", meaning: "to hold, to have", class: "godan", transitive: true },
    { kanji: "働く", reading: "はたらく", meaning: "to work", class: "godan", transitive: false },
    { kanji: "休む", reading: "やすむ", meaning: "to rest", class: "godan", transitive: false },
    { kanji: "住む", reading: "すむ", meaning: "to live, to reside", class: "godan", transitive: false },
    { kanji: "送る", reading: "おくる", meaning: "to send", class: "godan", transitive: true },
    { kanji: "泣く", reading: "なく", meaning: "to cry", class: "godan", transitive: false },
    { kanji: "売る", reading: "うる", meaning: "to sell", class: "godan", transitive: true },
    { kanji: "押す", reading: "おす", meaning: "to push", class: "godan", transitive: true },
    { kanji: "取る", reading: "とる", meaning: "to take", class: "godan", transitive: true },
    { kanji: "撮る", reading: "とる", meaning: "to take (a photo)", class: "godan", transitive: true },
    { kanji: "頼む", reading: "たのむ", meaning: "to ask (a favor), to request", class: "godan", transitive: true },
    { kanji: "貸す", reading: "かす", meaning: "to lend", class: "godan", transitive: true },
    { kanji: "出す", reading: "だす", meaning: "to take out, to submit", class: "godan", transitive: true },
    // ichidan
    { kanji: "食べる", reading: "たべる", meaning: "to eat", class: "ichidan", transitive: true },
    { kanji: "見る", reading: "みる", meaning: "to see, to watch", class: "ichidan", transitive: true },
    { kanji: "起きる", reading: "おきる", meaning: "to get up, to wake up", class: "ichidan", transitive: false },
    { kanji: "寝る", reading: "ねる", meaning: "to sleep", class: "ichidan", transitive: false },
    { kanji: "出る", reading: "でる", meaning: "to go out, to leave", class: "ichidan", transitive: false },
    { kanji: "忘れる", reading: "わすれる", meaning: "to forget", class: "ichidan", transitive: true },
    { kanji: "覚える", reading: "おぼえる", meaning: "to remember, to memorize", class: "ichidan", transitive: true },
    { kanji: "教える", reading: "おしえる", meaning: "to teach", class: "ichidan", transitive: true },
    { kanji: "考える", reading: "かんがえる", meaning: "to think, to consider", class: "ichidan", transitive: true },
    { kanji: "答える", reading: "こたえる", meaning: "to answer", class: "ichidan", transitive: true },
    { kanji: "決める", reading: "きめる", meaning: "to decide", class: "ichidan", transitive: true },
    { kanji: "開ける", reading: "あける", meaning: "to open", class: "ichidan", transitive: true },
    { kanji: "閉める", reading: "しめる", meaning: "to close", class: "ichidan", transitive: true },
    { kanji: "集める", reading: "あつめる", meaning: "to gather, to collect", class: "ichidan", transitive: true },
    { kanji: "始める", reading: "はじめる", meaning: "to start", class: "ichidan", transitive: true },
    { kanji: "続ける", reading: "つづける", meaning: "to continue", class: "ichidan", transitive: true },
    { kanji: "変える", reading: "かえる", meaning: "to change (something)", class: "ichidan", transitive: true },
    { kanji: "借りる", reading: "かりる", meaning: "to borrow", class: "ichidan", transitive: true },
    // できる ("to be able to / to be possible") is deliberately excluded
    // from this list entirely — it's the potential/possibility concept
    // ITSELF, so conjugating it for the "potential" form ("can be able
    // to...") or the other three forms never produces a sentence that
    // makes sense, no matter how transitivity is tagged.
    // irregular
    { kanji: "する", reading: "する", meaning: "to do", class: "irregular-suru", transitive: true },
    { kanji: "来る", reading: "くる", meaning: "to come", class: "irregular-kuru", transitive: false },
    { kanji: "勉強する", reading: "べんきょうする", meaning: "to study", class: "irregular-suru", transitive: true },
    { kanji: "練習する", reading: "れんしゅうする", meaning: "to practice", class: "irregular-suru", transitive: true },
    { kanji: "運動する", reading: "うんどうする", meaning: "to exercise", class: "irregular-suru", transitive: false },
    { kanji: "料理する", reading: "りょうりする", meaning: "to cook", class: "irregular-suru", transitive: true },
    { kanji: "掃除する", reading: "そうじする", meaning: "to clean", class: "irregular-suru", transitive: true },
    { kanji: "電話する", reading: "でんわする", meaning: "to telephone, to call", class: "irregular-suru", transitive: false },
  ];
